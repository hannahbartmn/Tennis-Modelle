...
for(j in J){
  ...
  sum_excluded_variables <- sum(c(any("home" %in% colnames(X)),
                                  ...
                                  any("H2H_carpet" %in% colnames(X)),
                                  any("H2H_clay" %in% colnames(X)),
                                  any("H2H_grass" %in% colnames(X)),
                                  any("H2H_hard" %in% colnames(X))))
  ...
  save(prediction, file = paste0("old_model_prediction_", j, ".RData")) #id hier hinzufuegen
