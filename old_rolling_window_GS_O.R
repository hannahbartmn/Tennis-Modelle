...
#for(j in J){
  ...
  # # Spiele entfernen, in denen Outlier gegen outlier spielt
  # index <- which(pred_subset$player_id == "Outlier" & pred_subset$opponent_id == "Outlier")
  # if(length(index) > 0){
  #   pred_subset <- pred_subset[-index,]
  # }
  ...
  w_2 <- w_time_4_years_1_halfperiod
  w_3 <- w_time_4_years_2_halfperiod
  w_4 <- w_time_4_years_3_halfperiod
  ...
  w_5 <- w_time_6_years_1_halfperiod
  w_6 <- w_time_6_years_3_halfperiod
  w_7 <- w_time_6_years_5_halfperiod
  ...
  save(prediction, file = paste0("GS_O_original_model_prediction_", j, ".RData")) #id hier hinzufuegen
